<section class="inner-header divider " data-bg-img="assets/images/bg/banner-bg.png" style="background-image: url('assets/images/bg/banner-bg.png'); background-position: bottom left;">
      <div class="container  pt-40">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-12">
              <h2 class="text-white text-center font-36">Festivals</h2>
              ...
              <div class="event-list  maxwidth500 mb-30 border-1px">
                <div class="thumb">
                  ...
                  <div class="entry-date media-left text-center flip bg-theme-colored pt-5 pr-15 pb-5 pl-15">
                    ...
                    <ul>
                      <li class="font-16 text-white font-weight-600 border-bottom"><?php echo $exp_date[2]; ?></li>
                      <li class="font-12 text-white text-uppercase"><?php echo $exp_date[1]; ?></li>
                    </ul>
                  </div>
                </div>
                <div class="event-list-details  bg-white clearfix p-20 pt-10 pb-20">
                  <h4 class="font-20 text-uppercase"><a href="page-single-cause.html"><?php echo $festival->sevas_page_title; ?></a></h4>
                  <ul class="list-inline font-weight-600">
                    <li><i class="fa fa-clock-o text-theme-colored"></i> <?php echo date('h:i a',strtotime($festival->celebration_time)); ?></li>
